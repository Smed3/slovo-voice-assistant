...
class Settings(BaseSettings):
    ...
    secret_key: str = Field(default="dev-secret-key-change-in-production", alias="AGENT_SECRET_KEY")
    ...
    database_url: str = Field(default="postgresql://localhost:5432/slovo", alias="DATABASE_URL")
